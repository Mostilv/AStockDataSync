...
- 次日 01:00 前：完成 **15/60 分钟** K 线入库
- 次日 09:30 前：完成上一交易日 **财务报表** 入库
- 每周五 17:30 前：执行 **周线/月线补点** 与完整性巡检
...
| 数据类别 | 时间范围 | 备注 |
| --- | --- | --- |
| 日/周/月 K 线 | 最近 10 年 | 首次建库全量回补，后续按 `last_*` 增量 |
| 15/60 分钟 K 线 | 2019-01-02 至今 | 固定起点，保持与官方一致 |
